...
export const ForgotPasswordScreen: React.FC<ForgotPasswordScreenProps> = ({
  ...
  const { forgotPassword, resetPassword, loading } = useAuthHook();
  ...
  const handleRequestLink = async () => {
    ...
    try {
      ...
      if (res.success) {
        setSuccessMessage(res.message || 'Reset link created successfully!');
        if (res.token) {
          setToken(res.token);
        }
        setPhase('reset');
      ...
      setError(err.message || 'Failed to request reset. User might not exist.');
    }
  };
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      >
        ...
        <View style={styles.header}>
          <TouchableOpacity style={styles.headerNavBtn} onPress={onNavigateToLogin} activeOpacity={0.7}>
          ...
          <View style={styles.card}>
            ...
            <View style={styles.headerContainer}>
              <Text style={styles.title}>
                {phase === 'request' ? 'Forgot Password?' : 'Enter New Password'}
              </Text>
            </View>
            ...
            {phase === 'request' ? (
                ...
                >
                  {loading ? (
                    ...
                    <>
                      ...
                      <Feather name="mail" size={20} color="#2e5b02" style={styles.submitBtnIcon} />
                    </>
                  )}
                </TouchableOpacity>
              </>
              ...
              <>
                <Text style={styles.fieldLabel}>
                  Please choose and enter a new password below.
                </Text>
